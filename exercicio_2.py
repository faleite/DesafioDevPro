""" Exercício 2
Exercícios com Arquivo. Lista Python Brasil.
"""
...
#1
with open('/Users/fabricio/usuarios.txt', 'r', encoding='utf-8') as arquivo:
...
with open('/Users/fabricio/relatorio.txt', 'w', encoding='utf-8') as arquivo:
